    ...
    return _then(_self.copyWith(
      ...
      perPage: freezed == perPage
          ...
          : perPage // ignore: cast_nullable_to_non_nullable
              as int?,
      recordsCount: freezed == recordsCount
          ? _self.recordsCount
...
extension PageInfoPatterns on PageInfo {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int? currentPage, int? pagesCount, int? nextPage,
            int? perPage, int? recordsCount)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _PageInfo() when $default != null:
        return $default(_that.currentPage, _that.pagesCount, _that.nextPage,
            _that.perPage, _that.recordsCount);
      case _:
        return orElse();
    }
  }
