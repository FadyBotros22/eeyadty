...
extension SendOtpRequestPatterns on SendOtpRequest {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SendOtpRequest value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String phoneNumber)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
/// @nodoc
@JsonSerializable()
class _SendOtpRequest extends SendOtpRequest {
  _SendOtpRequest({required this.phoneNumber}) : super._();
